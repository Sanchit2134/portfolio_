          ...
          >
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 sm:gap-1 border-2 border-black shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                Achieved React.js certification, showcasing proficiency 
                in the popular JavaScript library for building user 
                interfaces. Demonstrated ability to create dynamic and 
                interactive web applications, enhancing user experience 
                and interactivity. Leveraging React's component-based 
                architecture, I've developed scalable and maintainable 
                solutions. This certification reflects dedication to 
                mastering new technologies and a commitment to delivering 
                high-quality projects. It strengthens my portfolio, 
                highlighting expertise in modern web development and 
                adding value to prospective endeavors.
                </p>
              </div>
            </div>
          </fieldset>
